...
import { createMember, deleteMember, updateMember } from "@/back/adm/actions";
                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 w-full justify-center">
                            ...
                            <input className="border border-b-2 border-re px-2 py-1 w-full rounded-md" type="text" id="name" name="name" required/>
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            <label className="text-b" htmlFor="email">Email</label>
                            <input className="border border-b-2 border-re px-2 py-1 w-full rounded-md" type="email" id="email" name="email" required />
                            </div>
                            <div className="w-full flex flex-col gap-2">
                            <label className="text-b" htmlFor="cargo">Cargo</label>
                            <input className="border border-b-2 border-re px-2 py-1 w-full rounded-md" type="text" id="cargo" name="cargo" required />
                            </div>
